...
//         const selectedDate = selectedDates[0];
//         const deltaDates = selectedDate - todayDate;
//         deltaDates < 0 ? window.alert('Please choose a date in the future') : refs.btnStart.disabled = false;
//     },
// };
// const calendar = flatpickr(refs.input, options);
// let timerId = null;
...
//             const todayDate = Date.now();
//             const deltaDates = finalSelectedDate-todayDate;
//             const convertedDate = convertMs(deltaDates);
//             updateTimerInterface(convertedDate);
//         }, 3000);
//     },
//     stop() {
//         refs.btnStart.disabled = false;
